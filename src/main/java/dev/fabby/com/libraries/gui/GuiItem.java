...
import dev.fabby.com.libraries.gui.components.ItemNBT;
...
public final class GuiItem {
    ...
    /**
     * TarvosCore constructor of the GuiItem
     *
    ...
    public GuiItem(@NotNull final ItemStack itemStack, final GuiAction<InventoryClickEvent> action) {
        ...
        this.itemStack = ItemNBT.setString(itemStack, "fabby-gui", uuid.toString());
    }
